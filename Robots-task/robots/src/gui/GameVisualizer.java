...
public class GameVisualizer extends JPanel
{
    ...
    private ArrayList<IRobot> robotsList = new ArrayList<>(Arrays.asList(new DefaultRobot())) ;
    private final Target target = new Target(100, 50);
    ...
    public void addRobotLogic(IRobot robotLogic)
    {

        if (robotLogic != null) robotsList.add(robotLogic);
    }
    ...
    public void paint(Graphics g)
    {
        ...
        super.paint(g);
        for (IRobot robot:robotsList) {
            drawRobot(g2d, round(robot.getM_robotPositionX()),
                    round(robot.getM_robotPositionY()), robot);
        }
    ...
    private void drawRobot(Graphics2D g, int x, int y, IRobot robot)
    {
